...
const char*  BIRD2_SPRITE_FILE = "83127-sprite-area-line-animated-bird-film (2).png";
const int BIRD2_CLIPS[][4] = {
    {0, 0, 182, 168},
    {181, 0, 182, 168},
    {364, 0, 182, 168},
    {547, 0, 182, 168},
...
const int BIRD2_FRAMES = sizeof(BIRD2_CLIPS)/sizeof(int)/4;
